...
> RFC and guide documents for brownfield migration and documentation structure decisions.
...
1. **Understanding decisions**: Read RFC files for decision context
2. **Brownfield work**: Reference migration guide for legacy integration
...
| Task | File |
|------|------|
| Migrating legacy code | BROWNFIELD-MIGRATION-GUIDE.md |
| Understanding context structure decisions | RFC-UNIFIED-CONTEXT-STRUCTURE.md |
| Understanding docs structure decisions | RFC-UNIFIED-DOCS-STRUCTURE.md |
