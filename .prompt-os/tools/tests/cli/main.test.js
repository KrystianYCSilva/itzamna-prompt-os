...
describe('Main CLI Tool Tests', () => {
  test('executeTool should recognize available tools', async () => {
  ...
  test('executeTool should reject unknown tools', async () => {
    try {
  ...
  test('runToolAsSubprocess should execute tools as subprocess', async () => {
    // This test would actually run the tool as a subprocess
    // For safety, we'll just verify the function exists and has the right signature
    expect(typeof runToolAsSubprocess).toBe('function');
    console.log('runToolAsSubprocess function exists');
  });

  test('main CLI should handle different tool commands', async () => {
