...
| 5 — Rust Systems Programming | allowed (< 80) | 60 | allowed | — | N/A |

| Metric | Value |
|--------|-------|
| Total drafts | 5 |
| Near-duplicate (≥ 90) caught | 1 / 1 (100%) |
| High overlap (80-89) caught | 3 / 3 (100%) |
| Allowed (< 80) correctly passed | 1 / 1 (100%) |
| **False negatives** | **0** |
| SC-003 target (zero false negatives) | ✅ **PASS** |
...
- **Draft 2** landed at 89 — top edge of the high-overlap tier. The "automation" concept exists in python's description which kept Desc high, but the lack of a unique sub-domain tag prevented it from crossing into ≥ 90.
...
*SC-003 Results | SPEC-004 | Walk-through executed 2026-02-03*
